...
C = pickle.load(open("config.pickle",'rb'))
img_path = "C:/Users/jane/Desktop/training_data/PASCAL VOC/VOCdevkit/VOC2012/JPEGImages"
...
RPN, classifier, full = model_builder.build_models(img_input,C.num_rois, num_anchors, len(class_mapping))
