...
public class MNISTConfig
{
    ...
    public final double NEURON_ADD_CHANCE = 0.02;
    public final double FILTER_ADD_CHANCE = 0.15;
    ...
    public final double FILTER_MUTATION_RATE = 0.7;
    public final double FILTER_REPLACEMENT_RATE = 0.7;
    public final int NUM_IMAGE_COLOR_CHANNELS = 1;
